source("c:/Program Files/R/ccc.r")
source("c:/Program Files/R/required.funcs.r")
setwd("f:/2017 Labadie/FU2021 Training/ReferenceCountsTraining/R Code")
require(lattice) 

#F:\UWTV SURVEYS FU2022 CELTIC SEA\2016 Labadie\FU2021 Training\ReferenceCountsTraining\R Code
#F:\UWTV SURVEYS ARAN\2015 Aran Grounds\FU 17 Training\ReferenceCountsTraining\R Code
...
panel.abline(h=0.5, lty=2, col=1)
  ...
  #layout change to numer of counters (x,1)
  #cex=change legend size
